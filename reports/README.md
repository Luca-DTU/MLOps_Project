...
The second figure shows 200 epochs with a subset of 10000 observations. Evaluation is done every 1000 steps. We clearly see that our loss is decreasing with the number of epochs.

![Alt text](figures/sweep.png?raw=true "sweep")
![Alt text](figures/train-eval-loss.png?raw=true "train-eval-loss.png")
